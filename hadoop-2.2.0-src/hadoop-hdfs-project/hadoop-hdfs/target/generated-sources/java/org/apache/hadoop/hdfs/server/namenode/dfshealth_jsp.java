 ...
 */
 ...
 if (isActive && fsn != null) { 
      ...
      out.print( NamenodeJspHelper.getSecurityModeText());
      out.write("</b>\n<b> ");
      out.print( NamenodeJspHelper.getSafeModeText(fsn));
      out.write("</b>\n<b> ");
      out.print( NamenodeJspHelper.getRollingUpgradeText(fsn));
      out.write("</b>\n<b> ");
      out.print( NamenodeJspHelper.getInodeLimitText(fsn));
      out.write("</b>\n");
      out.print( NamenodeJspHelper.getCorruptFilesWarning(fsn));
