...
public final class QJournalProtocolProtos {
  ...
  public interface GetEditLogManifestRequestProtoOrBuilder
    ...
    /**
     * <code>optional bool forReading = 3 [default = true];</code>
     *
     * <pre>
  ...
  public static final class GetEditLogManifestRequestProto extends
    ...
    // optional bool forReading = 3 [default = true];
    public static final int FORREADING_FIELD_NUMBER = 3;
    private boolean forReading_;
    /**
     * <code>optional bool forReading = 3 [default = true];</code>
     *
     * <pre>
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        output.writeBool(3, forReading_);
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && (hasForReading() == other.hasForReading());
      if (hasForReading()) {
        result = result && (getForReading()
            == other.getForReading());
      }
    ...
    public int hashCode() {
      ...
      if (hasForReading()) {
        hash = (37 * hash) + FORREADING_FIELD_NUMBER;
        hash = (53 * hash) + hashBoolean(getForReading());
      }
      if (hasInProgressOk()) {
    ...
    public static final class Builder extends
      ...
      public org.apache.hadoop.hdfs.qjournal.protocol.QJournalProtocolProtos.GetEditLogManifestRequestProto buildPartial() {
        ...
        result.forReading_ = forReading_;
        if (((from_bitField0_ & 0x00000008) == 0x00000008)) {
          to_bitField0_ |= 0x00000008;
        }
      ...
      public Builder mergeFrom(org.apache.hadoop.hdfs.qjournal.protocol.QJournalProtocolProtos.GetEditLogManifestRequestProto other) {
        ...
        if (other.hasForReading()) {
          setForReading(other.getForReading());
        }
      ...
      // optional bool forReading = 3 [default = true];
      private boolean forReading_ = true;
      /**
       * <code>optional bool forReading = 3 [default = true];</code>
       *
       * <pre>
       ...
       * </pre>
       */
      public Builder setForReading(boolean value) {
        bitField0_ |= 0x00000004;
        forReading_ = value;
        onChanged();
        return this;
       ...
       * </pre>
       */
      public Builder clearForReading() {
        bitField0_ = (bitField0_ & ~0x00000004);
        forReading_ = true;
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "2\033.hadoop.hdfs.JournalIdProto\"K\n\034GetJour" +
      ...
      "coveryResponseProto\0224\n\014segmentState\030\001 \001(" +
      "\0132\036.hadoop.hdfs.SegmentStateProto\022\027\n\017acc" +
      "eptedInEpoch\030\002 \001(\004\022\027\n\017lastWriterEpoch\030\003 " +
      "\002(\004\022\031\n\021lastCommittedTxId\030\004 \001(\004\"\224\001\n\032Accep" +
      "tRecoveryRequestProto\022.\n\007reqInfo\030\001 \002(\0132\035" +
      ".hadoop.hdfs.RequestInfoProto\0225\n\rstateTo" +
      "Accept\030\002 \002(\0132\036.hadoop.hdfs.SegmentStateP" +
      "roto\022\017\n\007fromURL\030\003 \002(\t\"\035\n\033AcceptRecoveryR" +
      "esponseProto2\220\t\n\027QJournalProtocolService",
      "\022Z\n\013isFormatted\022$.hadoop.hdfs.IsFormatte" +
      "dRequestProto\032%.hadoop.hdfs.IsFormattedR" +
      "esponseProto\022f\n\017getJournalState\022(.hadoop" +
      ".hdfs.GetJournalStateRequestProto\032).hado" +
      "op.hdfs.GetJournalStateResponseProto\022Q\n\010" +
      "newEpoch\022!.hadoop.hdfs.NewEpochRequestPr" +
      "oto\032\".hadoop.hdfs.NewEpochResponseProto\022" +
      "K\n\006format\022\037.hadoop.hdfs.FormatRequestPro" +
      "to\032 .hadoop.hdfs.FormatResponseProto\022N\n\007" +
      "journal\022 .hadoop.hdfs.JournalRequestProt",
      "o\032!.hadoop.hdfs.JournalResponseProto\022T\n\t" +
      "heartbeat\022\".hadoop.hdfs.HeartbeatRequest" +
      "Proto\032#.hadoop.hdfs.HeartbeatResponsePro" +
      "to\022f\n\017startLogSegment\022(.hadoop.hdfs.Star" +
      "tLogSegmentRequestProto\032).hadoop.hdfs.St" +
      "artLogSegmentResponseProto\022o\n\022finalizeLo" +
      "gSegment\022+.hadoop.hdfs.FinalizeLogSegmen" +
      "tRequestProto\032,.hadoop.hdfs.FinalizeLogS" +
      "egmentResponseProto\022T\n\tpurgeLogs\022\".hadoo" +
      "p.hdfs.PurgeLogsRequestProto\032#.hadoop.hd",
      "fs.PurgeLogsResponseProto\022o\n\022getEditLogM" +
      "anifest\022+.hadoop.hdfs.GetEditLogManifest" +
      "RequestProto\032,.hadoop.hdfs.GetEditLogMan" +
      "ifestResponseProto\022f\n\017prepareRecovery\022(." +
      "hadoop.hdfs.PrepareRecoveryRequestProto\032" +
      ").hadoop.hdfs.PrepareRecoveryResponsePro" +
      "to\022c\n\016acceptRecovery\022\'.hadoop.hdfs.Accep" +
      "tRecoveryRequestProto\032(.hadoop.hdfs.Acce" +
      "ptRecoveryResponseProtoBH\n(org.apache.ha" +
      "doop.hdfs.qjournal.protocolB\026QJournalPro",
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_hadoop_hdfs_GetJournalStateResponseProto_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_hadoop_hdfs_GetJournalStateResponseProto_descriptor,
              new java.lang.String[] { "LastPromisedEpoch", "HttpPort", });
          internal_static_hadoop_hdfs_FormatRequestProto_descriptor =
          ...
          internal_static_hadoop_hdfs_GetEditLogManifestRequestProto_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_hadoop_hdfs_GetEditLogManifestRequestProto_descriptor,
              new java.lang.String[] { "Jid", "SinceTxId", "ForReading", "InProgressOk", });
          internal_static_hadoop_hdfs_GetEditLogManifestResponseProto_descriptor =
            getDescriptor().getMessageTypes().get(23);
          internal_static_hadoop_hdfs_GetEditLogManifestResponseProto_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_hadoop_hdfs_GetEditLogManifestResponseProto_descriptor,
              new java.lang.String[] { "Manifest", "HttpPort", });
          internal_static_hadoop_hdfs_PrepareRecoveryRequestProto_descriptor =
